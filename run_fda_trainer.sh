...
#SBATCH --gres=gpu:gtx1080:4 # gpu resources ## use :gtx1080: or :rtx2080: or :v100: or :a40: (you can ask for more than 1 gpu if you want)
#SBATCH --job-name=fdabert_trainer # a name just for you to identify your job easily
...
srun python3 -m torch.distributed.launch \
    --nproc_per_node 4 fdabert_trainer.py \
