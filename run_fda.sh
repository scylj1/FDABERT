...
#SBATCH --gres=gpu:gtx1080:2 # gpu resources ## use :gtx1080: or :rtx2080: or :v100: or :a40: (you can ask for more than 1 gpu if you want)
#SBATCH --job-name=fdabert2 # a name just for you to identify your job easily
...
srun python3 fdabert.py \
    ...
    --output_dir "/nfs-share/lj408/FDABERT/fdabert/client2/" \
