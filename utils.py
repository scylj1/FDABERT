...
def load_data(args, train_file, validation_file):
    data_files = {}
...
def train(args, model, tokenizer, raw_datasets, workers, device):
...
def test(args, model, tokenizer, raw_datasets, workers, device ):
    ...
    return float(eval_loss), {"perplexity": perplexity}, len(eval_dataset)