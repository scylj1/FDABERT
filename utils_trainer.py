...
def load_data(model_args, data_args, training_args, train_file, validation_file):
    data_files = {}
...
def initialise(train_file, validation_file, model_args, data_args, training_args):
    ...
    raw_datasets = load_data(model_args, data_args, training_args, train_file, validation_file)
...
def train(model_args, data_args, training_args, trainer, train_dataset):
    if training_args.do_train:
        checkpoint = None
...
def test(model_args, data_args, training_args, trainer, eval_dataset):
    if training_args.do_eval:
    ...
    return float(metrics["eval_loss"]), {"perplexity": perplexity}